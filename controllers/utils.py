...
class RegisterHandler(BaseHandler):
    ...
    def post(self):
        ...
        subject = "Welcome to X-Informatics"
        body = "Dear " + name + ", Example HTML content"
        html = "<p>Dear " + name + ",</p><p>Example HTML content</p>"
        mail.send_mail(sender_address, user_address, subject, body, html=html)
        # send a confirmation email
        #mandrill_key = "mfU0WroOFAer1a6iN3XfgQ"
        #mandrill_url = "https://mandrillapp.com/api/1.0/messages/send.json"
        #my_payload = {
        #    "key": mandrill_key,
        #    "message": {
        #        "html": "<p>Dear "+name+",</p><p>Example HTML content</p>",
        #        "subject": "testing email using Mandrill",
        #        "from_email": "cglmoocs@gmail.com",
        #        "from_name": "X-Informatics",
        #        "to": [
        #            {
        #                "email": user.email(),
        #            }
