...
UNITS_HEADER = (
    'id,type,unit_id,title,release_date,now_available,coding,resources,files,overview,new_overview,doi,total_time')
LESSONS_HEADER = (
    'unit_id,unit_title,lesson_id,lesson_title,lesson_activity,'
    'lesson_activity_name,lesson_notes,lesson_video_id,lesson_objectives,additional_resources')
...
UNIT_CSV_TO_DB_CONVERTER = {
    ...
    'new_overview': ('new_overview', unicode),
    'doi': ('doi', unicode),
...
LESSON_CSV_TO_DB_CONVERTER = {
    ...
    'additional_resources': ('resources', unicode),
...
class Unit(object):
    ...
    def list_properties(self, name, output):
        ...
        output.append('%s[\'resources\'] = %s;' % ( #resources
            name, str(self.resources).lower()))
        output.append('%s[\'files\'] = %s;' % ( #files
            name, str(self.files).lower()))
        output.append('%s[\'overview\'] = %s;' % ( #overview
            name, str(self.overview).lower()))
        output.append('%s[\'new_overview\'] = %s;' % ( #new_overview
            name, str(self.new_overview).lower()))
        output.append('%s[\'doi\'] = %s;' % ( #doi
            name, str(self.doi).lower()))
        output.append('%s[\'total_time\'] = %s;' % ( #total_time
            name, str(self.total_time).lower()))
...
class Lesson(object):
    ...
    def list_properties(self, name, output):
        ...
        output.append('%s[\'additional_resources\'] = \'%s\';' % (
            name, escape_quote(self.additional_resources)))
